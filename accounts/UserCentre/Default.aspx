                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="taobaopay" style="display: none;">
                                        <div class="message">
                                            <ul>
                                                <li><em>·</em>请按1比9.53的汇率计算人民币数额到以下地址拍下等额数量即可。如冲值100镑换算人民币是953元，请拍953件即可。拍后请立即确认付款，我们审核通过后您就可以在系统内查到您的冲值余额。</li>
                                    ...
                                    <div id="worldpay" class="message" style="display: none;">
                                        ...
                                        <input type="hidden" name="cartId" value="13570_735534185@qq.com_1430807879">
				...
				<span id="mnyTip"></span>
                            ...
                            <tr id="image" style="display: none;">
                                ...
                                <td>
                                    ...
                                    <script type="text/javascript" src="http://express-xc.co.uk/statics/js/uploadify/jquery.uploadify.min.js?v=9296"></script>
                                    <script>
                                        $(function () {
                                            $('#uploadify').uploadify({
                                                swf: '/statics/js/uploadify/uploadify.swf',
                                                formData: { 'api': 'uploadify|pic|single', 'token': '6b79a77180e9ec3a7ca351ebe54641a2' },
                                                uploader: '/accounts/UserCentre/UploadHandler.ashx',
                                                method: 'get',
                                                buttonText: '选择图片',
                                                queueID: 'fileQueue-1',
                                                fileTypeDesc: '支持的格式：',
                                                ...
                                                'onUploadStart': function (file) {
                                                    if ($('#upload-file-497536039500').html() != '') {
                                                        alert('请先删除上传的文件');
                                                        $('#uploadify-497536039500').uploadify('cancel');
                                                    }
                                                },
                                                onUploadSuccess: function (file, data, response) {
                                                    $('#upload-file-497536039500').html(data);
                                                }
                                            });
                                        });
                                    ...
                                    <div class="upload-file" id="upload-file-497536039500"></div>
                                </td>
                            </tr>
                            <tr>
