    ...
    <label for="id_billing_detail_email">Email</label> <input class="input-medium" id="id_billing_detail_email" maxlength="50" name="billing_detail_email" style="width:180px" type="text" />
        ...
        <div style="margin-top:10px;display:none;">
            ...
            <div class="rds2" style="padding:5px 2px;border:1px solid #ddd;background-color:#F2F8FC">
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_pickup_time_0">日期</label> <div id="8746b8ae75d64b25b45d925705765b89"  class="input-append date form_datetime"><input class="input-medium" foo_bar="prevent_readonly" id="id_pickup_time_0" name="pickup_time_0" type="text" value="9999-01-01" /><span class="add-on"><i class="icon-th"></i></span></div><script type="text/javascript">$("#8746b8ae75d64b25b45d925705765b89").datetimepicker({
    format : 'yyyy-mm-dd',
    ...
    <label style="font-weight:bold"><input type="checkbox" class="agreed" style="margin-top:-3px" /> 我同意服务条款</label>
        ...
        <div class="col-sm-2 col-xs-12" style="border:1px solid #69ADDB">
            <div class="panel" style="box-shadow:none">
                ...
                <p><strong>Bpost - Collect+ 便利店递送</strong></p>
                
                
                    <p><p><a href="/collect-%E6%9C%8D%E5%8A%A1%E8%AF%B4%E6%98%8E/" target="_blank"><img src="/static/media/uploads/collect_plus_banner.png" width="350" height="78" /></a></p>
<p><span style="color: #000000; font-size: medium; background-color: #ffff00;"><strong><a href="https://www.collectplus.co.uk/orders/new" target="_blank"><span style="color: #000000; background-color: #ffff00;"><span size="2">点击查询便利店地址</span></span></a></strong></span></p>
<p><span style="font-size: small;">国际快递时间（不包括清关和旺季延误）: 9-14 天 /&nbsp;自带丢件赔偿: &pound;50磅 /&nbsp;包裹上可贴中文地址</span></p></p>
