    ...
    <label for="id_billing_detail_email">Email</label> <input class="input-medium" id="id_billing_detail_email" maxlength="50" name="billing_detail_email" style="width:180px" type="text" />
        ...
        <div style="margin-top:10px;">
            ...
            <div class="rds2" style="padding:5px 2px;border:1px solid #ddd;background-color:#F2F8FC">
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_pickup_time_0">日期</label> <div id="ffb61d5772b1416aba4e5e42e8655a82"  class="input-append date form_datetime"><input class="input-medium" foo_bar="prevent_readonly" id="id_pickup_time_0" name="pickup_time_0" type="text" /><span class="add-on"><i class="icon-th"></i></span></div><script type="text/javascript">$("#ffb61d5772b1416aba4e5e42e8655a82").datetimepicker({
    format: 'yyyy-mm-dd',
    ...
    <label for="id_additional_instructions">备注</label> <input class="input-xxlarge" id="id_additional_instructions" maxlength="50" name="additional_instructions" style="width:290px" type="text" />
        ...
        <li class="addrItem" style="list-style:none;margin-top:20px;background-color:#ffffcd;border:1px solid #ddd">
            ...
            <div style="padding-top:10px">
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-cn_name">中文姓名</label> <input class="cn_fields cn_name" id="id_addr-0-cn_name" maxlength="24" name="addr-0-cn_name" style="width:60px" type="text" />
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-cn_city">中文城市</label> <input class="cn_fields cn_city" id="id_addr-0-cn_city" maxlength="24" name="addr-0-cn_city" style="width:60px" type="text" />
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-cn_street">中文地址</label> <input class="cn_fields cn_street" id="id_addr-0-cn_street" maxlength="72" name="addr-0-cn_street" style="width:415px" type="text" />
                ...
                <div style="margin-left:26px;float:left">
                    <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-postcode">邮编</label> <input id="id_addr-0-postcode" maxlength="6" name="addr-0-postcode" style="width:60px" type="text" />
                ...
                <div style="margin-left:26px;float:left">
                    <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-phone">电话</label> <input id="id_addr-0-phone" maxlength="11" name="addr-0-phone" style="width:100px" type="text" />
                ...
                <div class="hidden_address modal fade" style="display:none;clear:both">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-name">姓名</label> <input class="en_fields en_name" id="id_addr-0-name" maxlength="25" name="addr-0-name" style="width:250px" type="text" />
                        ...
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-city">城市</label> <input class="en_fields en_city" id="id_addr-0-city" maxlength="24" name="addr-0-city" style="width:250px" type="text" />
                        ...
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-street">地址</label> <input class="en_fields en_street" id="id_addr-0-street" maxlength="24" name="addr-0-street" style="width:250px" type="text" />
                    ...
                    <li class="parcelItem" style="list-style:none;margin-top:15px">
                        ...
                        <div class="rds2" style="padding-top:10px;background-color:#E0EDF4;border:1px solid #ddd;">
                            ...
                            <div class="ib">
                                ...
                                <div class="ib pd7">
                                    重量(kg)
                                    <div><input class="input-small" id="id_parcel-0-weight" name="parcel-0-weight" style="width:55px" type="text" value="15.0" /></div>
                                </div>
                                <div class="ib pd7">
                                    长度(cm)
                                    <div><input class="input-small" id="id_parcel-0-length" name="parcel-0-length" style="width:55px" type="text" value="12" /></div>
                                </div>
                                <div class="ib pd7">
                                    宽度(cm)
...
<option value="个人行李 - 旧衣物">个人行李 - 旧衣物</option>
                                        ...
                                        <div class="ib mx_quantity mx_cal">
                                            数量: <input id="id_parcel-0-content-0-quantity" name="parcel-0-content-0-quantity" style="width:40px" type="text" />
                                        </div>
                                        <div class="ib mx_cost mx_cal">
                                            单价(£): <input id="id_parcel-0-content-0-cost" name="parcel-0-content-0-cost" style="width:40px" type="text" />
                                        </div>
                                        <div class="ib">
...
<option value="个人行李 - 旧衣物">个人行李 - 旧衣物</option>
                                        ...
                                        <div class="ib mx_quantity mx_cal">
                                            数量: <input id="id_parcel-1-content-0-quantity" name="parcel-1-content-0-quantity" style="width:40px" type="text" />
                                        </div>
                                        <div class="ib mx_cost mx_cal">
                                            单价(£): <input id="id_parcel-1-content-0-cost" name="parcel-1-content-0-cost" style="width:40px" type="text" />
                                        </div>
                                        <div class="ib">
                                            <button style="border:1px solid #ddd;background:none" class="btn add_mx btn_mx" type="button" title="添加包裹明细"><i class="icon-plus icon-white"></i></button>
                                        </div>
        ...
        <li class="addrItem" style="list-style:none;margin-top:20px;background-color:#ffffcd;border:1px solid #ddd">
            ...
            <div style="padding-top:10px">
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-cn_name">中文姓名</label> <input class="cn_fields cn_name" id="id_addr-1-cn_name" maxlength="24" name="addr-1-cn_name" style="width:60px" type="text" />
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-cn_city">中文城市</label> <input class="cn_fields cn_city" id="id_addr-1-cn_city" maxlength="24" name="addr-1-cn_city" style="width:60px" type="text" />
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-cn_street">中文地址</label> <input class="cn_fields cn_street" id="id_addr-1-cn_street" maxlength="72" name="addr-1-cn_street" style="width:415px" type="text" />
                ...
                <div style="margin-left:26px;float:left">
                    <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-postcode">邮编</label> <input id="id_addr-1-postcode" maxlength="6" name="addr-1-postcode" style="width:60px" type="text" />
                ...
                <div style="margin-left:26px;float:left">
                    <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-phone">电话</label> <input id="id_addr-1-phone" maxlength="11" name="addr-1-phone" style="width:100px" type="text" />
                ...
                <div class="hidden_address modal fade" style="display:none;clear:both">
                    ...
                    <div class="modal-body">
                        <div style="background-color:#e1e1e1">中文姓名：<span class="cn_name_en"></span></div>
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-name">姓名</label> <input class="en_fields en_name" id="id_addr-1-name" maxlength="25" name="addr-1-name" style="width:250px" type="text" />
                        ...
                        <div style="background-color:#e1e1e1">中文城市：<span class="cn_city_en"></span></div>
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-city">城市</label> <input class="en_fields en_city" id="id_addr-1-city" maxlength="24" name="addr-1-city" style="width:250px" type="text" />
                        ...
                        <div style="background-color:#e1e1e1">中文地址：<span class="cn_street_en"></span></div>
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-1-street">地址</label> <input class="en_fields en_street" id="id_addr-1-street" maxlength="24" name="addr-1-street" style="width:250px" type="text" />
...
<option value="个人行李 - 旧衣物">个人行李 - 旧衣物</option>
                                        ...
                                        <div class="ib mx_quantity mx_cal">
                                            数量: <input id="id_parcel-2-content-0-quantity" name="parcel-2-content-0-quantity" style="width:40px" type="text" />
                                        </div>
                                        <div class="ib mx_cost mx_cal">
                                            单价(£): <input id="id_parcel-2-content-0-cost" name="parcel-2-content-0-cost" style="width:40px" type="text" />
                                        </div>
                                        <div class="ib">
                                            <button style="border:1px solid #ddd;background:none" class="btn add_mx btn_mx" type="button" title="添加包裹明细"><i class="icon-plus icon-white"></i></button>
                                        </div>
