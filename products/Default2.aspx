                                ...
                                <div style="margin-top: 10px;">
                                    ...
                                    <div class="rds2" style="padding: 5px 2px; border: 1px solid #ddd; background-color: #F2F8FC">
                                        ...
                                        <div style="float: left; margin: 5px" class="control-group ">
                                            ...
                                            <div id="ff" class="input-append date form_datetime">
                                        ...
                                        <div class="rds2" style="padding-top: 10px; background-color: #E0EDF4; border: 1px solid #ddd;">
                                            ...
                                            <div class="ib">
                                                ...
                                                <div class="ib pd7">
                                                    重量(kg)
                                    <div>
                                        <input class="input-small" id="id_parcel-0-weight" name="parcel-0-weight" style="width: 55px" type="text" value="1.0" /></div>
                                                </div>
                                                <div class="ib pd7">
                                                    长度(cm)
                                    <div>
                                        <input class="input-small" id="id_parcel-0-length" name="parcel-0-length" style="width: 55px" type="text" value="1" /></div>
                                                </div>
                                                <div class="ib pd7">
                                                    宽度(cm)
                                    <div>
            ...
            <div id="dialog-addrs" title="地址簿" style="background-color: #fff; display: none; font-size: 13px">
                ...
                <div class="addr_row">
                    ...
                    <label style="display: block; margin-right: 40px">
                        ...
                        <div style="display: inline-block; width: 100px" class="addr-name">d<br />
                            D</div>
                        <div style="display: inline-block; width: 100px">d<br />
                            D</div>
