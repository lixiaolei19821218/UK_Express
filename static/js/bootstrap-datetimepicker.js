...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
        this.daysDisabled = options.daysDisabled || [];
	...
	Datetimepicker.prototype = {
		...
		fill: function() {
			...
			while(prevMonth.valueOf() < nextMonth) {
                ...
                var date_format = DPGlobal.parseFormat('yyyy-mm-dd', this.formatType);
				if ((prevMonth.valueOf() + 86400000) <= this.startDate || prevMonth.valueOf() > this.endDate ||
					$.inArray(prevMonth.getUTCDay(), this.daysOfWeekDisabled) !== -1 ||
					$.inArray(DPGlobal.formatDate(prevMonth, date_format, this.language, this.formatType), this.daysDisabled) !== -1) {
					clsName += ' disabled';
				}
