...
<form class="form-inline" id="tree" action="" method="post">
    <input type='hidden' name='csrfmiddlewaretoken' value='zCirPTxRSAzXueyeKc0KQjf825JWUB1E' />
    <input id="id_addr-TOTAL_FORMS" name="addr-TOTAL_FORMS" type="hidden" value="1" /><input id="id_addr-INITIAL_FORMS" name="addr-INITIAL_FORMS" type="hidden" value="0" /><input id="id_addr-MAX_NUM_FORMS" name="addr-MAX_NUM_FORMS" type="hidden" value="1000" />
    <input id="id_parcel-TOTAL_FORMS" name="parcel-TOTAL_FORMS" type="hidden" value="1" /><input id="id_parcel-INITIAL_FORMS" name="parcel-INITIAL_FORMS" type="hidden" value="0" /><input id="id_parcel-MAX_NUM_FORMS" name="parcel-MAX_NUM_FORMS" type="hidden" value="1000" />
    ...
    <label for="id_billing_detail_email">Email</label> <input class="input-medium" id="id_billing_detail_email" maxlength="50" name="billing_detail_email" style="width:180px" type="text" />
        ...
        <div style="margin-top:10px;">
            ...
            <div class="rds2" style="padding:5px 2px;border:1px solid #ddd;background-color:#F2F8FC">
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_pickup_time_0">日期</label> <div id="5f1a9d3772834f5ba0b1c44633876908"  class="input-append date form_datetime"><input class="input-medium" foo_bar="prevent_readonly" id="id_pickup_time_0" name="pickup_time_0" type="text" value="2015-03-26" /><span class="add-on"><i class="icon-th"></i></span></div><script type="text/javascript">$("#5f1a9d3772834f5ba0b1c44633876908").datetimepicker({
    format : 'yyyy-mm-dd',
    ...
    <label for="id_additional_instructions">备注</label> <input class="input-xxlarge" id="id_additional_instructions" maxlength="50" name="additional_instructions" style="width:290px" type="text" />
        ...
        <li class="addrItem" style="list-style:none;margin-top:20px;background-color:#ffffcd;border:1px solid #ddd">
            ...
            <div style="padding-top:10px">
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-cn_name">中文姓名</label> <input class="cn_fields cn_name" id="id_addr-0-cn_name" maxlength="24" name="addr-0-cn_name" style="width:60px" type="text" value="1" />
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-cn_city">中文城市</label> <input class="cn_fields cn_city" id="id_addr-0-cn_city" maxlength="24" name="addr-0-cn_city" style="width:60px" type="text" value="1" />
                ...
                <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-cn_street">中文地址</label> <input class="cn_fields cn_street" id="id_addr-0-cn_street" maxlength="72" name="addr-0-cn_street" style="width:415px" type="text" value="1" />
                ...
                <div style="margin-left:26px;float:left">
                    <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-postcode">邮编</label> <input id="id_addr-0-postcode" maxlength="6" name="addr-0-postcode" style="width:60px" type="text" value="111111" />
    ...
    <label for="id_addr-0-phone">电话</label> <input id="id_addr-0-phone" maxlength="11" name="addr-0-phone" style="width:100px" type="text" value="18010631890" />
                ...
                <div class="hidden_address modal fade" style="display:none;clear:both">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-name">姓名</label> <input class="en_fields en_name" id="id_addr-0-name" maxlength="25" name="addr-0-name" style="width:250px" type="text" value="1" />
                        ...
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-city">城市</label> <input class="en_fields en_city" id="id_addr-0-city" maxlength="24" name="addr-0-city" style="width:250px" type="text" value="1" />
                        ...
                        <div style="float:left;margin:5px" class="control-group ">
    <label for="id_addr-0-street">地址</label> <input class="en_fields en_street" id="id_addr-0-street" maxlength="24" name="addr-0-street" style="width:250px" type="text" value="1" />
...
<option value="个人行李 - 旧衣物">个人行李 - 旧衣物</option>
                                        ...
                                        <div class="ib mx_quantity mx_cal">
                                            数量: <input id="id_parcel-0-content-0-quantity" name="parcel-0-content-0-quantity" style="width:30px" type="text" value="1" />
                                        </div>
                                        
                                        <div class="ib mx_cost mx_cal">
                                            单价(£): <input id="id_parcel-0-content-0-cost" name="parcel-0-content-0-cost" style="width:30px" type="text" value="1.00" />
                                        </div>
        ...
        <div class="col-sm-2 col-xs-12" style="border:1px solid #69ADDB">
            <div class="panel" style="box-shadow:none">
                <div style="margin-top:10px">
                        ...
                        <img src="/static/media/carriers/logo/parcelforce-large.png" style="width:130px" />
...
<div id="dialog-addrs" title="地址簿" style="background-color:#fff;display:none;font-size:13px">
    ...
    <div>
        ...
        <label style="display:block;margin-right:40px">
            <input type="radio" name="recv_addr" class="recv_addr" value="48168" style="display:none" />
        ...
        <script>recv_addr_dict['48168'] = ['1', '1', '1', '1', '1', '1', '', '', '111111', '18010631890'];</script>
...
<div class="container" style="background:none;padding-top:20px">
    <div class="row" style="margin-top:10px">
        <div class="col-sm-8">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6"><a href="/cid/" class="clrb1">身份证上传</a></div>
            </div>
            <div class="row">
        ...
        <div class="col-sm-4">
            <div style="float:right;width:220px">
                ...
                <div class="clrb1" style="font-size:24px">01293 537 035</div>
            </div>
    ...
    <script src="/static/js/tree2.js?v=150619"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#tree').on('click', '.add_mx', function(){
                ...
                $('#tree').find('.parcelItem').each(function(i){
                    $(this).find('.mx').each(function(j){
                        ...
                        $(this).find('.mx_goods_category select').attr('name', 'parcel-'+i+'-content-'+j+'-goods_category');
                        $(this).find('.mx_goods_name input').attr('name', 'parcel-'+i+'-content-'+j+'-goods_name');
                        $(this).find('.mx_type select').attr('name', 'parcel-'+i+'-content-'+j+'-type');
                        $(this).find('.mx_goods select').attr('name', 'parcel-'+i+'-content-'+j+'-goods');
                        $(this).find('.mx_quantity input').attr('name', 'parcel-'+i+'-content-'+j+'-quantity');
                        $(this).find('.mx_cost input').attr('name', 'parcel-'+i+'-content-'+j+'-cost');
                    });
            ...
            $('.addrItem').each(function(){
                ...
                var $phone = $addr_item.find('input[name$=-phone]').val();
                var $name = $addr_item.find('input[name$=-cn_name]').val();
                if($phone && $name){
                  check_cid_exist($addr_item);
                }
            });
            ...
            $('#dialog-addrs').find('.recv_addr').click(function(){
                ...
                if($current_addr_item){
                    ...
                    $current_addr_item.find('[id$=postcode]').trigger('blur');
                ...
                check_cid_exist($current_addr_item);
            });
            ...
            $('#root').on('blur', 'input[name$=-phone], input[name$=-cn_name]', function(){
              check_cid_exist($(this).closest('.addrItem'));
            });
        });

        function check_cid_exist($addr_item)
        {
          var $phone = $addr_item.find('input[name$=-phone]').val();
          var $name = $addr_item.find('input[name$=-cn_name]').val();
          if($phone && $name){
            $addr_item.find('.cid_exist').html('...');
            $.get("/cid/exist/?name=" + $name + '&phone=' + $phone, function(data){
              if(data == '1')
                $addr_item.find('.cid_exist').html('(已上传)');
              else
                $addr_item.find('.cid_exist').html('(未上传)');
            });
          }
        }
    </script>
    ...
    <script type="text/javascript">
adroll_adv_id = "E2OOKSKE7BHMXJHQQUWOYV";
adroll_pix_id = "PPQ3V5CH3JAERGOULCVNUF";
(function () {
